...
#set_property PACKAGE_PIN V17 [get_ports {freq_shell[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[0]}]
## SWITCH 1
#set_property PACKAGE_PIN V16 [get_ports {freq_shell[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[1]}]
## SWITCH 2
#set_property PACKAGE_PIN W16 [get_ports {freq_shell[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[2]}]
## SWITCH 3
#set_property PACKAGE_PIN W17 [get_ports {freq_shell[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[3]}]
## SWITCH 4
#set_property PACKAGE_PIN W15 [get_ports {freq_shell[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[4]}]
## SWITCH 5
#set_property PACKAGE_PIN V15 [get_ports {freq_shell[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[5]}]
## SWITCH 6
#set_property PACKAGE_PIN W14 [get_ports {freq_shell[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[6]}]
## SWITCH 7
#set_property PACKAGE_PIN W13 [get_ports {freq_shell[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[7]}]
## SWITCH 8
#set_property PACKAGE_PIN V2 [get_ports {freq_shell[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[8]}]
## SWITCH 9
#set_property PACKAGE_PIN T3 [get_ports {freq_shell[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {freq_shell[9]}]
## SWITCH 10
...
## UP BUTTON
#set_property PACKAGE_PIN T18 [get_ports en_ext]						
#	set_property IOSTANDARD LVCMOS33 [get_ports en_ext]
## LEFT BUTTON
#set_property PACKAGE_PIN W19 [get_ports load_shell]						
#	set_property IOSTANDARD LVCMOS33 [get_ports load_shell]
## RIGHT BUTTON
#set_property PACKAGE_PIN T17 [get_ports clr_shell]						
#	set_property IOSTANDARD LVCMOS33 [get_ports clr_shell]
## DOWN BUTTON
...
##====================================================================
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {sci_in}]					
...
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {spi_data}]					
